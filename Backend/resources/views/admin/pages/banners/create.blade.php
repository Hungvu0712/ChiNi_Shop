                ...
                <div class="card">
                    ...
                    @if ($isBannerActive)
                        <div class="alert alert-warning">
                            <strong>Lưu ý:</strong> Hiện tại đã có 1 banner đang hiển thị. Nếu bật cái này, vui lòng tắt cái
                            cũ.
                        </div>
                    @endif
                    ...
                    <div class="card-body">
                        <form action="{{ route('banners.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="content" id="summernote" rows="10" class="form-control" placeholder="Nhập nội dung banner">{{ old('content') }}</textarea>
                                @error('content')
                                    <div class="error-message">
                                        <i class="bi bi-exclamation-circle"></i> {{ $message }}
                                    </div>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch mb-3">
                                    <!-- Hidden input để đảm bảo gửi active = 0 nếu không check -->
                                    ...
                                    <label class="form-check-label fw-bold" for="activeCheck">
                                        Hiển thị banner (chỉ một banner được hiển thị)
                                    </label>
