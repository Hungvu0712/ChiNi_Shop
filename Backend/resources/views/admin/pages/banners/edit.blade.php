...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="card-title">Sửa thông tin banner</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('banners.update', $banner->id) }}" method="post"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="file-upload-wrapper">
                                    <label class="file-upload-label">
                                        ...
                                        <span class="file-upload-hint">Định dạng: JPG, PNG, GIF. Kích thước tối đa:
                                            2MB</span>
                                        <input type="file" name="banner_image" class="file-upload-input"
                                            accept="image/*">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="content" id="summernote" rows="10" class="form-control" placeholder="Nhập nội dung banner">{{ $banner->content }}</textarea>
                                @error('content')
                                    <div class="error-message">
                                        <i class="bi bi-exclamation-circle"></i> {{ $message }}
                                    </div>
    ...
    <!-- Hidden input để gửi active = 0 nếu không check -->
    ...
    <input
        ...
        name="active"
        value="1"
        {{ old('active', $banner->active) == 1 ? 'checked' : '' }}
    >
    <label class="form-check-label fw-bold" for="activeCheck">Hiển thị banner</label>
