    ...
    <div class="row">
        <div class="col-lg-16">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('banners.update', $banner->id) }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="file-upload-wrapper">
                                <label class="file-upload-label">
                                    ...
                                    <img src="{{$banner->banner_image}}" alt="" style="width:200px; height:100px">
                                </label>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="summernote" rows="10" 
                                class="form-control" 
                                placeholder="Nhập nội dung banner">{{ $banner->content }}</textarea>
                            @error('content')
                                <div class="error-message">
                                    <i class="bi bi-exclamation-circle"></i> {{ $message }}
                                </div>
