        ...
        <div class="row profile-header py-4 mb-4">
            <div class="col-12">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="d-flex">
                        <span class="badge bg-light text-dark me-2"><i class="bi bi-person-check me-1"></i> Đã xác thực</span>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <ul class="nav nav-pills mb-4" id="profileTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="activity-tab" data-bs-toggle="pill" data-bs-target="#activity" type="button" role="tab">Hoạt động</button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="profileTabContent">
                            ...
                            <div class="tab-pane fade show active" id="overview" role="tabpanel">
                                <div class="detail-item">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Giới tính:</strong> {{ $user->profile?->gender ?? 'Chưa cập nhật' }}</p>
                                            <p><strong>Ngày sinh:</strong> {{ $user->profile?->birthday ?? 'Chưa cập nhật' }}</p>
                                        </div>
                                        <div class="col-md-6">
