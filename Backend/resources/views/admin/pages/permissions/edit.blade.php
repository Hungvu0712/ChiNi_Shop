    ...
    @can('permssion-edit')
        <div class="card" style="width: 100%">
            <div class="card-header">
                <div class="card-title">Sửa thông tin permission - <strong
                        style="color: rgb(221, 110, 110)">{{ $permissionID->name }}</strong></div>
            </div>
            <div class="card-body">
                <form action="{{ route('permissions.update', $permissionID->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{ $permissionID->name }}" class="form-control mb-2"
